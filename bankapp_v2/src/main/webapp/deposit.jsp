<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
    ...
    <body>
        ...
        <%if(session.getAttribute("customer")==null){ response.sendRedirect("login.html"); } %>
            ...
            <!-- <form action = "deposit">
<!-- Enter Deposit amount<input type = "text" name="deposit">
<input type = "submit" value = "submit">
</form> --> -->
            <!-- <div class="form-group">
                <label for="for state">Depoist Amount</label>
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="inputGroupPrepend"><i class="fas fa-rupee-sign"></i></span>
                    </div>
                    <input type="text" id="deposit" class="form-control" placeholder="Enter Your Deposit Amount">
                </div>
                <button id="btn1" class="btn btn-success" type="button">Submit</button>
            </div> -->
            <!-- Enter Deposit Amount <input type="text" name="" id="deposit">
<button id="btn1" class="btn btn-success" type="button">Submit</button> -->

            <!-- <div class="container">
                <button id="b1" class="btn btn-primary" type="button">Get All Employee</button><br />
                <br />
            </div>
            <div id="results" class="container"> -->
                ...
                <script>
                    btn1.onclick = () => {
                        ...
                        let url = "http://localhost:8080/bankapp_v2/deposit?deposit=" + document.getElementById("deposit").value;
                        fetch(url)
