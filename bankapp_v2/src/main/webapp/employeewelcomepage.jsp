...
<!--Logout ends-->
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <form>
            <button type="button" id="btn" class="btn btn-primary btn-lg btn-block">Open Customer Account</button>
          </form><br>
         <form action="">
            <button type="button" id="b2" class="btn btn-danger btn-lg btn-block">View Customer Personal Details</button>
         </form><br>
        </div>
        <br><br>       
            <div class="col-lg-6">
                <form action="">
                    <button type="button" id="b3" class="btn btn-success btn-lg btn-block">View Customer Account Details</button>
                </form><br/>
              <form action=""><button type="button" id="b4" class="btn btn-warning btn-lg btn-block">View Customer Transactions</button></form>
            </div>
