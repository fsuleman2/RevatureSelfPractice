...
<body>
 ...
 <section class="colored-section" id="title">
    <div class="container-fluid">
        ...
        <h2>Customer Transaction Details Panel</h2>
            <div class="row">
                <div class="col-lg-6">
...
<br><br>
<h3><strong>All Customer Transaction Details by Username</strong></h3>
<div id="results1" class="container"></div>
<br><br>
<h3><strong>All  Customer Transaction Details</strong></h3>
<div id="results2" class="container"></div>
<script>
    b1.onclick = () =>{
        let url = "http://localhost:8080/bankapp_v2//viewtrasactiondetails?username="+document.getElementById("username").value;
        fetch(url)
    ...
    b2.onclick = () =>{
        let url = "http://localhost:8080/bankapp_v2/viewtransaction";
        fetch(url)
            .then(response => response.json())
            .then(res => {
                let data = "<table class='table table-striped table-bordered table-responsive'> <thead class='thead-dark'><tr><th>Transaction Id</th><th>Customer User Name</th><th>Transaction Type</th><th>Opening Balance</th><th>Transaction Amount</th><th>Transaction Date</th><th>Closing Balance</th></thead><tbody>"
