...
<!-- <form action="transfer" method="post">
    Enter First Name <input type="text" name="creditorname"><br/>
    Enter Last Name <input type="number" name="transferamount"><br/>
                 ...
                 <!--Creditor Username Ends  -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="transferamount" class="form-control" placeholder="Enter Amount to Transfer" required>
                        </div>
                    </div>
